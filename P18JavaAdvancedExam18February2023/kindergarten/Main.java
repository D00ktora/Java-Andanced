...
public class Main {
    public static void main(String[] args) {
        ...
        Child childOne = new Child("D", "Petrova", 3, "Selena", "0899");
        Child childTwo = new Child("C", "Petrova", 3,"Max", "0888");
        Child childThree = new Child("B", "Petrova", 3,"Ivan", "0988");
        Child childFour = new Child("A", "Petrova", 3,"George", "0789");
