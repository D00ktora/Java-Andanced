...
public class P12TheMatrix {
    public static void main(String[] args) throws IOException {
        ...
        Arrays Arrays;
        int rows = java.util.Arrays.stream(reader.readLine().trim().split("\\s+")).mapToInt(Integer::parseInt)
                .findFirst().orElse(0);
        ...
        int[] startPosition = java.util.Arrays
        ...
        System.out.println(java.util.Arrays.stream(matrix)
                .map(String::new)
